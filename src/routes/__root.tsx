...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "A physics-informed neural digital twin of Bihar's climate — live compound flood + heat risk at block level, 3-hour update cycle, and a what-if simulator for disaster response." },
      { property: "og:description", content: "A physics-informed neural digital twin of Bihar's climate — live compound flood + heat risk at block level, 3-hour update cycle, and a what-if simulator for disaster response." },
      { name: "twitter:description", content: "A physics-informed neural digital twin of Bihar's climate — live compound flood + heat risk at block level, 3-hour update cycle, and a what-if simulator for disaster response." },
